...
function App() {
  ...
  return (<div className="flex flex-col justify-center items-center h-dvh">
    <div className="bg-gradient-to-tr from-gray-300 to-neutral-700 p-5 shadow-lg rounded w-1/3 text-center">
      <h1 className="text-3xl font-black">Todo-List</h1>
      <h3 className="my-3 text-lg">Please enter any activities to add todo-list</h3>
      ...
      {activity.map((item, index) => {
        return (<div key={index} className="border-b border-black flex justify-around items-center my-5">
          <h1 className="text-lg font-semibold m-3">{index + 1}. {item.name}</h1>
